...
var jsonObject=JSON.parse(fs.readFileSync('ol_not_come_yet.json', 'utf8'));
...
function showPrice() {
  async.each(files, function(file, callback) {
    ...
    stock.get('http://localhost/daibik/ol/find_ol_today.php?symbol='+file.symbol, function(err, data) {
      console.log(data);
    });
  });
}
