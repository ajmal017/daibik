...
function fetchPrice() {
  async.each(files, function(file, callback) {
    var url = 'https://nseindia.com/live_market/dynaContent/live_watch/get_quote/GetQuoteFO.jsp?underlying='+file.symbol.replace(/&/gi, function myFunction(x){return '%26';})+'&instrument=FUTSTK&expiry='+expiry+'&type=-&strike=-#';
