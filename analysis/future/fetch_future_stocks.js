...
var expiry = '27SEP2018';
//var stock_symbol = 'APOLLOHOSP';

async.each(files, function(file, callback) {
  var url = 'https://www.nseindia.com/live_market/dynaContent/live_watch/get_quote/getFOHistoricalData.jsp?underlying='+file.symbol.replace(/&/gi, function myFunction(x){return '%26';})+'&instrument=FUTSTK&expiry='+expiry+'&type=-&strike=-&fromDate=undefined&toDate=undefined&datePeriod=1month&fileDnld=true';
