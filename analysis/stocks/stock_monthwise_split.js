...
function showPrice() {
  async.each(files, function(file, callback) {
    ...
    stock.get('http://localhost/daibik/analysis/stocks/stock_monthwise_split.php?symbol='+file.symbol.replace(/&/gi, function myFunction(x){return '_';}), function(err, data) {
      if ( data != '' ) {
        console.log(data);
      }
    });
