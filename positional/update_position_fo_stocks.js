...
function showPrice() {
  async.each(files, function(file, callback) {
    ...
    stock.get('http://localhost/daibik/positional/update_position_fo_stocks.php?symbol='+file.symbol.replace(/&/gi, function myFunction(x){return '_';}), function(err, data) {
      console.log(data);
    });
  });
}
